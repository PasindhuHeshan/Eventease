            ...
            <?php foreach ($orgevents as $event): ?>
                ...
                <div class="event">
                    ...
                    <div class="event-details">
                        ...
                        <p class="event-description"><?php if(($userType=='3')||($userType=='4')){ echo '<a href="inquiry?no=' . $event['no'] . '">Inquiries</a>';} ?></p>
                        <p class="event-description"><?php if(($userType=='3')||($userType=='4')){ echo '<a href="enrollment?no=' . $event['no'] . '">Enrollment</a>';} ?></p>
                        <p class="event-description"><?php if(($userType=='3')||($userType=='4')){ echo '<a href="review?no=' . $event['no'] . '">Review</a>';} ?></p>
                        <p class="event-description"><?php if(($userType=='3')||($userType=='4')){ echo '<a href="statistics?no=' . $event['no'] . '">Statistics</a>';} ?></p>
                        <p class="event-description"><?php if(($userType=='3')||($userType=='4')){ echo '<a href="report?no=' . $event['no'] . '">Report</a>';} ?></p>
                    </div>
                </div>
            <?php endforeach; ?>
        <?php else: ?>
